...
$wrapper = new LegacyFilterWrapper('Procedure', $link);
...
if (isset($_GET['submit'])) {
    ...
    $status = isset($_GET['status']) ? $_GET['status'] : 'Secured';
?>
...
<?php if ($rowCount == 0): ?>
    <div class='alert alert-warning' style='margin:20px;'>
        ...
        <p>Tidak ada dokumen Procedure dengan filter yang Anda pilih.</p>
    </div>
<?php else: ?>
...
<?php
    ...
    echo "<p>Pilih <strong>Section</strong> dan <strong>Status</strong>, lalu klik <strong>Show</strong> untuk menampilkan dokumen Procedure.</p>";
    echo "</div>";
}
?>
