...
<br /><br />
<h1>Form's List For Section: <strong><?php echo htmlspecialchars($section);?></strong>
...
<?php if ($rowCount == 0): ?>
    <div class='alert alert-warning' style='margin:20px;'>
        ...
        <p>Tidak ada dokumen Form dengan filter yang Anda pilih.</p>
        <hr>
        ...
        <p class='text-muted'><small>Coba gunakan filter yang berbeda.</small></p>
    </div>
<?php else: ?>
...
<?php
    ...
    echo "<p>Pilih <strong>Section</strong>, <strong>Status</strong>, dan <strong>Category</strong>, lalu klik <strong>Show</strong> untuk menampilkan dokumen Form.</p>";
    echo "</div>";
}
?>
